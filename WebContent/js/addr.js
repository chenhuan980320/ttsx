function bindAddr(path){
	var pro=document.getElementById("shop_dialog_province");
	var city=document.getElementById("shop_dialog_city");
	var area=document.getElementById("shop_dialog_area");
